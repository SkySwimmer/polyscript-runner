...
public interface IPolyscriptPlugin extends IEventReceiver {
	...
	public default void onEvaluate(PolyScriptEngine engine, PolyScript script, JsonVariablesProcessor processor, JsonVariablesContext local, JsonVariablesContext global) {
	}
